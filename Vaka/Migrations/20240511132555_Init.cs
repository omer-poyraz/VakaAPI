        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stores_Structures_StructureId",
                        column: x => x.StructureId,
                        principalTable: "Structures",
                        principalColumn: "StructureId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "RoomId");
                    table.ForeignKey(
                        name: "FK_WorkOrders_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "StoreId");
                    table.ForeignKey(
                        name: "FK_WorkOrders_Structures_StructureId",
                        column: x => x.StructureId,
                        principalTable: "Structures",
                        principalColumn: "StructureId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrders_StoreId",
                table: "WorkOrders",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkOrders_StructureId",
                table: "WorkOrders",
                column: "StructureId");
        }
