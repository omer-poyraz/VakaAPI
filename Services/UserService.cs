...
namespace Services
{
    public class UserService : IUserService
    {
        ...
        {
            var userDto = await _manager.UserRepository.GetUserAsync(userId, trackChanges);
        ...
        {
            var user = await _manager.UserRepository.GetUserAsync(userId, trackChanges);
            try
            {
                _manager.UserRepository.DeleteUser(user);
