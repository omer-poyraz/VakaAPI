...
namespace Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        private User? _user;
        public AuthenticationService(ILoggerService loggerService, RepositoryContext context, IMapper mapper, UserManager<User> userManager, IConfiguration configuration)
        {
        ...
        public async Task<TokenDto> CreateToken(bool populateExpire)
        {
            ...
            return new TokenDto { UserId = _user.UserId, AccessToken = accessToken, RefreshToken = refreshToken };
        }
